...
<form autocomplete="off" id="user_alias">                                                                                          
...
foreach ($aliases as $alias => $verified) {                                                                                
  ...
  $result .= "<li class='aliasaction' data-alias=\"$alias\" > $alias                                                     
    <img class='deletebutton' title='Delete alias' src=" . OCP\Util::imagePath( 'core', 'actions/delete.png') . ">                    
    $status                                                                                                      
    </li>";                                                                                                      
}                                                                                                                          
